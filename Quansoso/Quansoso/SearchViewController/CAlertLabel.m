...
+ (CAlertLabel *)alertLabelWithFrame:(CGRect)frame andText:(NSString *)text
{
...
+ (CAlertLabel *)alertLabelWithAdjustFrameForText: (NSString *)text
{
    ...
    [alertLabel setFrame:CGRectMake((kMainScreenWidth - labelWidth)/2, (kMainScreenHeight-labelHeight)/2 - 50.0, labelWidth, labelHeight)];
    return alertLabel;
}
...
+ (CAlertLabel *)alertLabelInHeadForText:(NSString *)text andIsHaveNavigationBar:(BOOL)isHave{
    CAlertLabel *alertLabel = [[CAlertLabel alloc] initWithFrame:CGRectMake(0, isHave?64.0:20.0, kMainScreenWidth, 30)];
